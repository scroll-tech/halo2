...
pub fn best_group_fft<G>(a: &mut [G], omega: G::Scalar, log_n: u32)
where
    G: Group,
    G::Scalar: PrimeField,
{
    ...
    if sub_n < split_m {
        ...
        parallel_group_fft(a, omega, log_n);
    }
}

fn serial_fft<G>(a: &mut [G], omega: G::Scalar, log_n: u32)
where
    G: Group,
    G::Scalar: PrimeField,
{
...
fn serial_split_fft<G>(a: &mut [G], twiddle_lut: &[G::Scalar], twiddle_scale: usize, log_n: u32)
where
    G: Group,
    G::Scalar: PrimeField,
{
...
pub fn parallel_group_fft<G>(a: &mut [G], omega: G::Scalar, log_n: u32)
where
    G: Group,
    G::Scalar: PrimeField,
{
...
pub fn g_to_lagrange<C: CurveAffine>(g_projective: Vec<C::Curve>, k: u32) -> Vec<C> {
    ...
    best_group_fft(&mut g_lagrange_projective, omega_inv, k);
