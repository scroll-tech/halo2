...
#[derive(Clone, Debug)]
pub struct Message<F: PrimeField, const K: usize, const MAX_WORDS: usize>(Vec<MessagePiece<F, K>>);

impl<F: PrimeField + PrimeFieldBits, const K: usize, const MAX_WORDS: usize>
...
impl<F: PrimeField + PrimeFieldBits, const K: usize, const MAX_WORDS: usize> std::ops::Deref
...
#[derive(Clone, Debug)]
pub struct MessagePiece<F: PrimeField, const K: usize> {
    cell_value: AssignedCell<F, F>,
    /// The number of K-bit words in this message piece.
    num_words: usize,
}

impl<F: PrimeField + PrimeFieldBits, const K: usize> MessagePiece<F, K> {
