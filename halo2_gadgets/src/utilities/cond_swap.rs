...
pub trait CondSwapInstructions<F: PrimeField>: UtilitiesInstructions<F> {
...
impl<F: PrimeField> Chip<F> for CondSwapChip<F> {
...
impl<F: PrimeField> UtilitiesInstructions<F> for CondSwapChip<F> {
...
mod tests {
    ...
    use halo2_proofs::curves::pasta::pallas::Base;
    use halo2_proofs::ff::PrimeField;
